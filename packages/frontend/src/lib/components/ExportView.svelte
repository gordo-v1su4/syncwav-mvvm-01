<script lang="ts">
  ...
  // import { FileVideo, Play, Download, Loader2, CheckCircle2, AlertTriangle, Info, ChevronLeft } from 'svelte-lucide';
  import { projectStore } from '$lib/stores/projectStore';
  // import { exportVideo } from '$lib/utils/exportService'; // Assume this exists
  ...
  function previewExport(filename) {
    // Simulate preview
...
<div class="export-view">
  ...
  <div class="export-content">
      ...
      {:else if isExporting}
        <div class="export-progress">
          ...
          <div class="progress-bar-container">
            ...
            <!-- <Loader2 size={"20"} class="progress-icon spinning" /> -->
      ...
      {:else if exportComplete}
        <div class="export-complete">
          <div class="complete-info">
            <!-- <h4 class="success"> <CheckCircle2 size={"24"} /> Export Complete!</h4> -->
          ...
          <div class="complete-actions">
            ...
            <button
              ...
              on:click={() => previewExport(filename)}
              title="Preview exported video"
            >
              <!-- <Play size={"20"} /> -->
              Preview
            </button>
    ...
    {#if !isExporting && !exportComplete && exportStatus.includes('Failed')}
    ...
    <div class="export-tips">
      <!-- <h4> <Info size={"18"} /> Export Tips & Considerations</h4> -->
      <h4> Export Tips & Considerations</h4>
      <ul>
        <li>Ensure your browser has sufficient memory and processing power.</li>
      </ul>
    </div>

    <button class="back-button" on:click={() => $uiStore.appMode = 'edit'}>
      <!-- <ChevronLeft size={"16"} /> -->
      Back to Edit Mode
    </button>
  </div>
...
<style>
  ...
  .export-error-message h3 {
    color: var(--color-error);
    margin-bottom: var(--spacing-sm);
  }

  .export-error-message p {
    color: var(--text-secondary);
  }
