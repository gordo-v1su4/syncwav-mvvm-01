 ...
 * @returns {Array<any>}
 */
export function extract_waveform_peaks(audio_data, samples_per_pixel) {
    const ptr0 = passArrayF32ToWasm0(audio_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extract_waveform_peaks(ptr0, len0, samples_per_pixel);
    return ret;
}
 ...
 */
export function generate_waveform(samples, downsample_factor) {
    const ret = wasm.generate_waveform(samples, downsample_factor);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_e6ce5b3c680c9b7e = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('artivus_rust_modules_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
